...
export type FixedWriteMonthlyTransactionSign = typeof FixedWriteMonthlyTransactionSign[keyof typeof FixedWriteMonthlyTransactionSign];


export const FixedWriteMonthlyTransactionSign = {
  NUMBER_MINUS_1: -1,
  NUMBER_1: 1,
} as const;
