 ...
 */
import type { FixedListResponseMonthlyTransactionListItemMonthlyTransactionSign } from './fixedListResponseMonthlyTransactionListItemMonthlyTransactionSign';
import type { Identifier } from './identifier';
import type { NullableIdentifier } from './nullableIdentifier';

export type FixedListResponseMonthlyTransactionListItem = {
  monthly_transaction_id: Identifier;
  monthly_transaction_name: string;
  /** @minimum 0 */
  monthly_transaction_amount: number;
  monthly_transaction_sign: FixedListResponseMonthlyTransactionListItemMonthlyTransactionSign;
