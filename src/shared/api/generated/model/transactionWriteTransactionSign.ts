...
export type TransactionWriteTransactionSign = typeof TransactionWriteTransactionSign[keyof typeof TransactionWriteTransactionSign];


export const TransactionWriteTransactionSign = {
  NUMBER_MINUS_1: -1,
  NUMBER_1: 1,
} as const;
