...
const categoryPresentations: Record<string, CategoryPresentation> = {
  食費: {
    ...
    selectionClassName: 'bg-warning/10',
  },
  外食: {
    icon: Utensils,
    iconClassName: 'bg-warning/12 text-warning',
  ...
  ショッピング: {
    ...
    selectionClassName: 'bg-chart-3/10',
  },
  ファッション: {
    icon: Shirt,
    iconClassName: 'bg-chart-5/12 text-chart-5',
    dotClassName: 'bg-chart-5',
    selectionClassName: 'bg-chart-5/10',
  },
  WEBサービス: {
    icon: Smartphone,
  ...
  '旅行・レジャー': {
    ...
    selectionClassName: 'bg-chart-4/10',
  },
  交際費: {
    icon: Users,
    iconClassName: 'bg-success/12 text-success',
  ...
  '医療・健康': {
    icon: Cross,
    iconClassName: 'bg-expense/12 text-expense',
    dotClassName: 'bg-expense',
    selectionClassName: 'bg-expense/10',
  },
  車: {
    icon: Car,
    iconClassName: 'bg-chart-2/12 text-chart-2',
