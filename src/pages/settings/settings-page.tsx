...
function SettingsDetailPage({ children, description, title }: {
  ...
  return (
    <div className="motion-route-enter mx-auto w-full max-w-5xl px-5 pb-24 pt-5 md:px-10 md:pb-12 md:pt-8">
      <header className="border-b pb-4">
        ...
        <div className="space-y-1.5">
          <h1 id="page-title" className="text-xl font-semibold tracking-[-0.035em] md:text-2xl">{title}</h1>
...
export function SettingsPage() {
  return (
    <section aria-labelledby="page-title" className="motion-route-enter mx-auto w-full max-w-3xl px-5 pb-24 pt-5 md:px-10 md:pb-12 md:pt-8">
      <header className="flex items-start gap-4 border-b pb-4">
        ...
        <div className="space-y-1.5">
          <h1 id="page-title" className="text-xl font-semibold tracking-[-0.035em] md:text-2xl">設定</h1>
          <p className="max-w-2xl text-sm leading-6 text-muted-foreground md:text-base">アカウント、予算、支払い方法、表示に関する設定を管理します。</p>
        </div>
      </header>
      <div className="py-4 md:py-6"><SettingsSummary /></div>
    </section>
  )
}
