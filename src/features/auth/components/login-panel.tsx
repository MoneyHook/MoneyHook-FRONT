  ...
  return (
    <svg aria-hidden="true" className="login-google-mark" viewBox="0 0 24 24">
      <path
        ...
        d="M21.6 12.23c0-.71-.06-1.39-.18-2.03H12v3.84h5.38a4.6 4.6 0 0 1-1.99 3.02v2.49h3.21c1.88-1.73 3-4.28 3-7.32Z"
      />
      <path
        fill="var(--google-green)"
        d="M12 22c2.7 0 4.96-.9 6.61-2.45l-3.21-2.49c-.9.6-2.04.96-3.4.96-2.6 0-4.8-1.75-5.59-4.11H3.1v2.57A10 10 0 0 0 12 22Z"
      />
      <path
        fill="var(--google-yellow)"
        d="M6.41 13.91A6 6 0 0 1 6.1 12c0-.66.11-1.3.31-1.91V7.52H3.1A10 10 0 0 0 2 12c0 1.61.39 3.14 1.1 4.48l3.31-2.57Z"
      />
      <path
        fill="var(--google-red)"
        d="M12 5.98c1.47 0 2.79.51 3.83 1.51l2.87-2.87C16.95 2.99 14.7 2 12 2a10 10 0 0 0-8.9 5.52l3.31 2.57C7.2 7.73 9.4 5.98 12 5.98Z"
      />
    </svg>
  )
}
