  ...
  it('collects unique import months and finds only matching registered transactions', () => {
    const rows = createImportRows({
      rows: [
        ['日付', '名称', '金額'],
        ['2026/09/01', 'Amazon', '3,980'],
        ['2026/10/01', 'ランチ', '1,200'],
        ['2026/09/01', 'Amazon 再掲', '3,980'],
      ],
      headerRowIndex: 0,
      mapping: { amount: 2, date: 0, name: 1 },
      defaults,
    ...
    const matches = duplicateCandidatesByRowId({
      ...
      transactions: [
        ...
        {
          transaction_id: 'different-amount',
          transaction_name: 'Amazon',
          transaction_amount: 3981,
          transaction_sign: -1,
          transaction_date: '2026-09-01',
          category_id: 'food',
          category_name: '食費',
