...
export function SelectField({
  ...
  return <Select disabled={disabled} onValueChange={onValueChange} value={value}>
    <SelectTrigger aria-label={ariaLabel} className="h-10"><SelectValue placeholder={placeholder} /></SelectTrigger>
