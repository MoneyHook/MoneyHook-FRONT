  ...
  return (
    <AnalysisPanel className="p-3 sm:p-6">
      ...
      <div className="mt-3 grid grid-cols-3 divide-x sm:mt-6">
        <div className="min-w-0 pr-2 sm:pr-7">
          <p className="text-[0.6875rem] text-muted-foreground sm:text-sm">
            総支出
          </p>
          <p className="mt-1 text-[0.625rem] font-semibold tracking-[-0.05em] whitespace-nowrap tabular-nums min-[390px]:text-xs sm:text-3xl">
            {formatCurrency(data.expenseAmount)}
          </p>
          <p className="mt-1 text-[0.5rem] whitespace-nowrap text-muted-foreground tabular-nums min-[390px]:text-[0.625rem] sm:text-sm">
            月平均 {formatCurrency(data.monthlyAverageExpense)}
          </p>
        </div>
        <div className="min-w-0 px-2 sm:px-7">
          <p className="text-[0.6875rem] text-muted-foreground sm:text-sm">
            固定費
          </p>
          <p className="mt-1 text-[0.625rem] font-semibold tracking-[-0.05em] whitespace-nowrap tabular-nums min-[390px]:text-xs sm:text-3xl">
        ...
        <div className="min-w-0 pl-2 sm:pl-7">
          <p className="text-[0.6875rem] text-muted-foreground sm:text-sm">
            変動費
          </p>
          <p className="mt-1 text-[0.625rem] font-semibold tracking-[-0.05em] whitespace-nowrap tabular-nums min-[390px]:text-xs sm:text-3xl">
